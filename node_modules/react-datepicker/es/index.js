...
//se fija si se trato de instanciar el constructor
...
function generateYears(year, noOfYear, minDate, maxDate) {
  var list = [];
  //itenera entre i menor a 2 por noOfYear más i (itinera eternamente?)
  for (var i = 0; i < 2 * noOfYear + 1; i++) {
    //el nuevo año es igual al año menos  noOfYear -1
